...
var buttonStyle = {
  ...
  padding: '20px',
  fontFamily: 'Arial',
  webkitBoxShadow: '0px 0px 19px 0px rgba(0,0,0,0.3)',
  mozBoxShadow: ' 0px 0px 19px 0px rgba(0,0,0,0.3)',
  boxShadow: '0px 0px 19px 0px rgba(0,0,0,0.3)'
};
var divWrapper = {
  display: 'flex',
...
//# sourceMappingURL=4.5c386f4479dac69907d1.hot-update.js.map