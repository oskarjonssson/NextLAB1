...
function (_Component) {
  ...
  function EditProductButton(props) {
    ...
    _this.handleChangeType = _this.handleChangeType.bind(_assertThisInitialized(_this));
  ...
  _createClass(EditProductButton, [{
    ...
    value: function handleChange(event) {
      ...
      this.props.editProductName(this.props.passName, newProduct);
    }
  }, {
    key: "handleChangeType",
    value: function handleChangeType(event) {
      var newProduct = event.target.value;
      this.props.editProductType(this.props.passName, newProduct);
    }
  }, {
    key: "handleSubmit",
...
//# sourceMappingURL=4.ac7541f32c8d7fac2f16.hot-update.js.map