...
function (_Component) {
  ...
  function FetchData(props) {
    ...
    Object.defineProperty(_assertThisInitialized(_this), "addProduct", {
      ...
      writable: true,
      value: function value(name, product, type) {
        for (var i = 0; i < _this.state.apiData.length; i++) {
          if (_this.state.apiData[i].name === name) {
            console.log(_this.state.apiData[i].name);
...
//# sourceMappingURL=4.ff12cc81a24debd5809b.hot-update.js.map