...
function (_Component) {
  ...
  function FetchData(props) {
    ...
    _this.state = {
      apiData: [] //this.deleteData = this.deleteData.bind();

    };
    _this.handleClickDelete = _this.handleClickDelete.bind();
    return _this;
  }
  ...
  _createClass(FetchData, [{
    ...
    value: function render() {
      ...
      var deleteData = function deleteData(name, product) {
        var newData = _toConsumableArray(_this3.state.apiData);
      ...
      var list = this.state.apiData.map(function (data) {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
          ...
          onClick: _this3.handleClickDelete,
          __source: {
            fileName: _jsxFileName,
            lineNumber: 100
          }
...
//# sourceMappingURL=4.c66e54eccfa7526c19a3.hot-update.js.map