...
function (_Component) {
  ...
  function FetchData(props) {
    ...
    Object.defineProperty(_assertThisInitialized(_this), "handleDeleteButton", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(event) {
        console.log('data.name: ', data.name);
        var deleteTarget = event.target.value;

        _this.deleteData(data.name, deleteTarget);
      }
    });
    _this.state = {
      apiData: []
    ...
    _this.handleDeleteButton = _this.handleDeleteButton.bind();
    return _this;
  }
    ...
    value: function render() {
      ...
      var list = this.state.apiData.map(function (data) {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
          ...
          onClick: _this3.handleDeleteButton,
          __source: {
            fileName: _jsxFileName,
            lineNumber: 105
          }
...
//# sourceMappingURL=4.463d1e54fd2b64fc7efd.hot-update.js.map