...
function (_Component) {
  ...
  function FetchData(props) {
    ...
    Object.defineProperty(_assertThisInitialized(_this), "editProductName", {
      configurable: true,
      enumerable: true,
      writable: true,
    ...
    Object.defineProperty(_assertThisInitialized(_this), "editProductType", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(name, product, type) {
    ...
    value: function render() {
      ...
      var list = this.state.apiData.map(function (data) {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
          ...
          editProductName: _this3.editProductName,
          editProductType: _this3.editProductType,
...
//# sourceMappingURL=4.96f3bf9a82435fb21ef8.hot-update.js.map